...
-- Description: Initial database schema for Wandora
-- Date: 2024-01-15
-- Author: Setup
...
-- To rollback this migration, drop all tables and storage buckets:
-- DROP TABLE gemstone_views, saved_gemstones, gemstone_likes, gemstone_ratings, follows, gemstone_images, gemstones, users CASCADE;
-- DELETE FROM storage.buckets WHERE id IN ('gemstone-images', 'user-avatars');